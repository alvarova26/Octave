function [ro,vo,io,thetao] = FunctionBruteForce(m,max_risk)
%% Load Data
...
thetax(1,:) = [0.142857143 0.142857143 0.142857143 0.142857143 0.142857143 0.142857143 0.142857143 ]; % initial equally weighted parameters
